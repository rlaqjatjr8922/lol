...
class CoachWindow:
    def __init__(self):
        ...
        self.root.geometry("560x260+900+70")
        ...
        # 1단계
        # --------------------------
        self.step1_frame = tk.Frame(self.root, bg="#111111")

        step1_title = tk.Label(
            self.step1_frame,
            text="픽 순서와 라인을 선택하세요",
            fg="white",
            bg="#111111",
            font=("맑은 고딕", 12, "bold")
        )
        step1_title.pack(anchor="w", pady=(8, 12))

        pick_row = tk.Frame(self.step1_frame, bg="#111111")
        pick_row.pack(anchor="w", pady=(0, 10), fill="x")
        ...
        self.step1_lane_combo.pack(side="left", padx=(38, 0))
        ...
        # 2단계
        # --------------------------
        self.step2_frame = tk.Frame(self.root, bg="#111111")
        ...
        # 3단계
        # --------------------------
        self.step3_frame = tk.Frame(self.root, bg="#111111")
        ...
        self.waiting_label.pack(anchor="w", pady=(0, 10))
        ...
        self.result_title_label.pack(anchor="w", pady=(0, 10))

        self.result_body_label = tk.Label(
            self.step3_frame,
            text="",
            fg="white",
            bg="#111111",
        ...
        self.result_body_label.pack(anchor="w", pady=(0, 10))
        ...
        self.result_plan_label.pack(anchor="w", pady=(0, 10))
    ...
    def on_pick_change(self, event=None):
        if self.pick_order_var.get().strip() == "후픽":
            ...
            self.enemy_entry_step1.pack(side="left", padx=(10, 0))
            self.root.geometry("560x350+900+70")
        else:
            self.enemy_label_step1.pack_forget()
            self.enemy_entry_step1.pack_forget()
            self.enemy_row_step1.pack_forget()
            self.root.geometry("560x300+900+70")
    ...
    def show_step1(self):
        ...
        self.step1_frame.pack(fill="both", expand=True, padx=16, pady=10)
    ...
    def show_step2(self):
        self.current_step = 2
        self._hide_all_steps()
        self.step2_frame.pack(fill="both", expand=True, padx=16, pady=10)

        self.back_button.grid(row=0, column=0, sticky="ew", padx=4)
        self.next_button.grid(row=0, column=1, sticky="ew", padx=4)

        self.set_status("챔피언 정보 입력")
        self.root.geometry("700x600+900+70")
        self.root.update()

    def show_step3(self):
        self.current_step = 3
        self._hide_all_steps()
        self.step3_frame.pack(fill="both", expand=True, padx=16, pady=10)

        self.back_button.grid(row=0, column=0, sticky="ew", padx=4)
        self.next_button.grid(row=0, column=1, sticky="ew", padx=4)

        self.root.geometry("660x620+900+70")
        self.root.update()
    ...
    def show_waiting_in_step3(self, text="GPT 응답 대기중..."):
        ...
        self.result_body_label.config(text="")
    ...
    def set_result(self, title_text: str, body_text: str, plan_text: str):
        ...
        self.result_body_label.config(text=body_text or "")
